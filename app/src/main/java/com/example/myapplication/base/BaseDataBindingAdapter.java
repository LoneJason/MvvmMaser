...
public abstract class BaseDataBindingAdapter<M, B extends ViewDataBinding> extends ListAdapter<M, RecyclerView.ViewHolder> {
    ...
    public void submitList(@Nullable List<M> list) {
        // 在xml中recyclerView的submitList就会调用这里
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        // 调用子类的onBindItem方法，让子类去处理对应view处理
        // binding  视图
        // getItem(position) 数据
     ...
     * @param holder  .
     */
    protected abstract void onBindItem(ViewDataBinding binding, M item, RecyclerView.ViewHolder holder);
